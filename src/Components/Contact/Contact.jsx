...
const Contact = () => {
    const socialLinks = [
        {
          href: 'https://github.com/Rachit-2409',
        ...
        {
          href: 'https://www.linkedin.com/in/rachitgpt9090/',
          icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
          href: 'https://www.instagram.com/_rachit888/',
...
<div className="mb-12 lg:mb-0 lg:flex lg:flex-col">    
    ...
    <form action="https://getform.io/f/avrrjyma" method="POST" className="xl:pl-10 2xl:px-20">
    <div className="md:grid md:items-center md-grid-cols-2 md:gap-2">
                ...
                <div className="mb-4 ">
                    ...
                    <textarea name="message" id="message" placeholder="Hi!" className="text-field resize-y min-h-40 max-h-100"></textarea>
                </div>
